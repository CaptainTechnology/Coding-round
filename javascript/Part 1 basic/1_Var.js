...
// Hoisting with var -> declared at top, initialized with undefined
...
//   var x = 1;
//   if (true) {
//     let x = 2; // new block variable
//     const y = 3;
//     console.log("Inside block:", x, y); // 2, 3
//     var z=43;
//   }
...
// let num = 10;
// {
//   let num = 20; // shadows outer num
//   console.log("Inner num:", num); // 20
// }
// console.log("Outer num:", num); // 10
...
// var foo = 1;
// function updateFoo() {
//   var foo = 2; // local function variable
//   console.log("Inside function foo:", foo); // 2
// }
// updateFoo();
// console.log("Global foo:", foo); // 1
...
// // const with arrays and objects -> mutation allowed, reassignment not allowed
// const arr = [1, 2];
// arr.push(3);
// console.log("Modified arr:", arr); // [1,2,3]

// const obj = { name: "Anees" };
// obj.age = 25;
// console.log("Modified obj:", obj);
// // obj = {} // ❌ TypeError

// // var in loop -> same variable reused
...
// // Fixing var loop with IIFE (classic closure)
// for (var k = 0; k < 3; k++) {
//   (function(k) {
...
// // Tricky hoisting: var shadows outer scope inside function
// var value = 100;
// function tricky() {
